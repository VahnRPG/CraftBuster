...
local SKILL_NAME = CBL[CBT_SKILL_FISH];
...
local function CraftBuster_Module_Fishing_HandleAction(skill_data)
...
local function CraftBuster_Module_Fishing_DisplayActions(display_frame)
...
local function CraftBuster_Module_Fishing_OnLoad()
	...
	local module_options = {
		...
		action_function = CraftBuster_Module_Fishing_HandleAction,
		display_action_function = CraftBuster_Module_Fishing_DisplayActions,
	};
